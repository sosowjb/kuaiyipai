...
namespace Kuaiyipai.Web
{
    public class HttpHelper
    {
        ...
        public static Task<string> Request(string method, string url, string param, Action<HttpStatusCode, string> onComplete = null)
        {
        ...
        /// <param name="onComplete">完成后执行的操作(可选参数，通过此方法可以获取到HTTP状态码)</param>
        /// <returns>请求返回的结果</returns>
        public static async Task<string> Post(string url, string param, Action<HttpStatusCode, string> onComplete = null)
        {
            UrlCheck(ref url);
            ...
            return await HttpRequest(request, onComplete);
        }
        ...
        public static async Task<string> Get(string url, string param, Action<HttpStatusCode, string> onComplete = null)
        {
            UrlCheck(ref url);
        ...
        /// <param name="onComplete">完成后执行的操作(可选参数，通过此方法可以获取到HTTP状态码)</param>
        /// <returns>请求返回结果</returns>
        private static async Task<string> HttpRequest(HttpWebRequest request, Action<HttpStatusCode, string> onComplete = null)
        {
