...
using Kuaiyipai.Web.IdentityServer;
...
namespace Kuaiyipai.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Kuaiyipai API", Version = "v1" });
            ...
            return services.AddAbp<KuaiyipaiWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Kuaiyipai API V1");
            }); //URL: /swagger
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            app.Properties["host.AppName"] = "Kuaiyipai";
