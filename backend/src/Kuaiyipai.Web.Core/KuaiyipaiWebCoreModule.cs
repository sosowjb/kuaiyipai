...
using Kuaiyipai.Web.Authentication.TwoFactor;
using Kuaiyipai.Web.Configuration;
...
{
    [DependsOn(
        typeof(KuaiyipaiApplicationModule),
        typeof(KuaiyipaiEntityFrameworkCoreModule),
    ...
    public class KuaiyipaiWebCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(KuaiyipaiApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(KuaiyipaiWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(KuaiyipaiWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
