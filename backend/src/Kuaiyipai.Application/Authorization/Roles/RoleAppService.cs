...
using Kuaiyipai.Authorization.Permissions;
using Kuaiyipai.Authorization.Permissions.Dto;
using Kuaiyipai.Authorization.Roles.Dto;
using Microsoft.EntityFrameworkCore;

namespace Kuaiyipai.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : KuaiyipaiAppServiceBase, IRoleAppService
    {
