...
using Kuaiyipai.Authorization.Users.Profile.Cache;
using Kuaiyipai.Authorization.Users.Profile.Dto;
using Kuaiyipai.Friendships;
using Kuaiyipai.Identity;
using Kuaiyipai.Security;
using Kuaiyipai.Storage;
using Kuaiyipai.Timing;

namespace Kuaiyipai.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : KuaiyipaiAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Kuaiyipai",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Kuaiyipai",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
