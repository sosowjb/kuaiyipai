...
using Kuaiyipai.Migrations.Seed.Host;
...
namespace Kuaiyipai.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : KuaiyipaiAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<KuaiyipaiDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(KuaiyipaiConsts.ConnectionStringName).Value.ToString();
        }
