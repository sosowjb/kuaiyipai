...
using Kuaiyipai.EntityFrameworkCore.Repositories;

namespace Kuaiyipai.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : KuaiyipaiRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<KuaiyipaiDbContext> dbContextProvider)
