...
namespace Kuaiyipai.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = KuaiyipaiConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(KuaiyipaiDbContext context)
        {
            _context = context;
        }
