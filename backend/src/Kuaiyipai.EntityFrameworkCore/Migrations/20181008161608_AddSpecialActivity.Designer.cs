...
namespace Kuaiyipai.Migrations
{
    ...
    [Migration("20181008161608_AddSpecialActivity")]
    partial class AddSpecialActivity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kuaiyipai.Auction.Entities.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Auction.Entities.ItemAuctioning", b =>
                {
                    ...
                    b.Property<double?>("PriceLimit");

                    b.Property<Guid?>("SpecialActivityId");
            ...
            modelBuilder.Entity("Kuaiyipai.Auction.Entities.ItemPic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Auction.Entities.OrderCompleted", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Orders_Completed");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.OrderWaitingForEvaluating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Orders_WaitingForEvaluating");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.OrderWaitingForPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Orders_WaitingForPayment");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.OrderWaitingForReceiving", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Orders_WaitingForReceiving");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.OrderWaitingForSending", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Orders_WaitingForSending");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.Pillar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_Pillars");
                });

            modelBuilder.Entity("Kuaiyipai.Auction.Entities.SpecialActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("AUC_SpecialActivities");
                });
            ...
            modelBuilder.Entity("Kuaiyipai.Auction.Entities.UserBalanceRecord", b =>
                {
                    ...
                    b.Property<bool?>("IsPaidSuccessfully");

                    b.Property<DateTime>("PaymentCompleteTime");
            ...
            modelBuilder.Entity("Kuaiyipai.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.MultiTenancy.Accounting.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.MultiTenancy.Payments.SubscriptionPayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Kuaiyipai.Editions.SubscribableEdition", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Kuaiyipai.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Kuaiyipai.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Kuaiyipai.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Kuaiyipai.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Kuaiyipai.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Kuaiyipai.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
